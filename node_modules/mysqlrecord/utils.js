...
var format_conditions = exports.format_conditions = function( conditions , opts ){
	
	opts = opts || {};
	var start_with = opts.start_with || '';
	var end_with = opts.end_with || '';
	var with_table_name = opts.table || '';
